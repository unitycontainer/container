...
namespace Fields
{
    ...
    public partial class Injecting_Optional_With_Optional : Injection.Optional.Pattern
    {
        ...
        [ClassInitialize]
        public static void Injecting_Optional_With_Optional_Initialize(TestContext context) 
            => Injecting_Optional_With_Optional_Initialize(context.FullyQualifiedTestClassName);

        protected static void Injecting_Optional_With_Optional_Initialize(string name, Assembly assembly = null)
        {
