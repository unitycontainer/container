...
namespace Pipeline
{
    public partial class Behavior
    {
        ...
        {
            // Arrange
            var visitor = Pipelines<FakeContext>.ResolvedBuildUpPipelineFactory(Chain);
        ...
        [TestMethod("No overridden methods"), TestProperty(TEST, BUILDUP_RESOLVED)]
        public void Buildup_Resolved_NoStrategy()
        {
            // Arrange
