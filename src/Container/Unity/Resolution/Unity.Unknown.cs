...
namespace Unity
{
    public partial class UnityContainer
    {
        internal object? Resolve(ref PipelineContext context)
        {
            ...
            return (bool)isGeneric ? GenericUnregistered(ref generic, ref context)
        ...
        internal object? ResolveContract(ref Contract contract, ref PipelineContext parent)
        {
            ...
            do
            {
                ...
                {
                    var context = parent.CreateContext(container, ref contract, manager);
                    return container.GenericRegistration(generic.Type!, ref context);
                }
            }
            while (null != (container = container.Parent!));
            ...
            // No registration found, resolve unregistered
            return (bool)isGeneric ? GenericUnregistered(ref generic, ref child)
