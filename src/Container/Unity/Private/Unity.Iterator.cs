...
namespace Unity
{
    ...
    {
        private Iterator GetEnumerator(Type type, bool includeDefault)
        {
            var scope = _scope;
        ...
        private struct I_terator 
        {
            #region Fields

            public UnityContainer _container;
        ...
        private class Iterator : IEnumerable<ContainerRegistration>
        {
            #region Fields
            ...
            public Iterator(IList<Scope> scopes)
            {
                _scopes = scopes;
