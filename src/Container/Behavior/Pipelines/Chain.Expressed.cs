...
namespace Unity.Container
{
    ...
    {
        public static PipelineFactory<TContext> ChainToExpressionIteratedFactory(MemberProcessor[] chain)
        {
            var delegates = chain
                .Where(p =>
                {
        ...
        public static PipelineFactory<TContext> ChainToExpressionCompiledFactory(MemberProcessor[] chain)
        {
        ...
        public static PipelineFactory<TContext> ChainToExpressionResolvedFactory(MemberProcessor[] chain)
